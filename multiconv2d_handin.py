...
# class my_Conv2d_function(torch.autograd.Function):
#     @staticmethod
#     def forward(ctx, input):
#         ctx.save_for_backward(input)
#         my_Conv2d.sigma = 0.1 + (nn.sigmoid(my_Conv2d.sigma) * 0.5)
#         my_Conv2d.beta = 1.0 + (my_Conv2d.beta * 0.3)
#         kernel=conv2d_kernel(my_Conv2d.kernel_size,my_Conv2d.channel_in,my_Conv2d.channel_out, my_Conv2d.sigma,my_Conv2d.beta)
#         kernel = kernel.float()   
#         result = F.conv2d(input, kernel, stride=my_Conv2d.stride, padding=my_Conv2d.padding)
#         return result
